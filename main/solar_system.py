...
all_planets = [
    ...
    (108209000, 0.006772, 3.39, 54.884, 76.68, 0, "Venus", "gold"),
    (149596000, 0.0167086, 0, 114.207, -11.26, 0, "Earth", "mediumspringgreen"),
    (227939200, 0.0935, 1.85, 286.50, 49.558, 0, "Mars", "tomato"),
